...
public class AutoOp2425_right_ extends LinearOpMode {
    ...
    double timePerTile = 0.900140347916205 * 0.2;
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            program(1.0,-1.0,timePerTile,ARM_SCORE_SPECIMEN,WRIST_FOLDED_IN,INTAKE_OFF);//Robot rotates
            program(-1.0,-1.0,timePerTile * 0.5,ARM_SCORE_SPECIMEN,WRIST_FOLDED_IN,INTAKE_OFF);//Robot goes to high rung
            program(-1.0,1.0,timePerTile,ARM_SCORE_SPECIMEN,WRIST_FOLDED_IN,INTAKE_OFF);
            program(0,0,timePerTile,ARM_SCORE_SPECIMEN,WRIST_FOLDED_IN,INTAKE_DEPOSIT);//Robot stops to score
            program(-1.0,1.0,timePerTile,ARM_ATTACH_HANGING_HOOK,WRIST_FOLDED_OUT,INTAKE_OFF);//Robot rotates to go to low rung
