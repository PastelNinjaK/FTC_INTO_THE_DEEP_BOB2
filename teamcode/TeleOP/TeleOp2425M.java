    ...
    if (opModeIsActive()) {
      while (opModeIsActive()) {
        ...
        if(gamepad1.left_trigger != 0){
          double left_power_factor = gamepad1.left_trigger;
          SlidePosition -= 1 * left_power_factor;
        }
        if(gamepad.right_trigger != 0){
          double right_power_factor = gamepad1.right_trigger;
          SlidePosition += 1 * right_power_factor;
        }
